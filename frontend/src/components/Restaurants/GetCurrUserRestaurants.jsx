            ...
            {user ?
                <div>
                    <div style={{ position: "relative", marginRight: "0%", paddingLeft:"45em" , paddingRight:"0px"}} className='menu'>
                        <button style={{ backgroundColor: "rgb(141, 4, 4)", color: "white", boxShadow: "5px 5px 5px black", height: "3em",  cursor: "pointer", position: "relative", marginRight: "0%", marginTop: "5%", marginLeft: "75%" }}>
                            ...
                            {currentRestaurants.map((restaurant) => (
                                <>
                                    <div style={{ marginBottom: "3px" }} className="photos-div">
                                        ...
                                        <div className="photos" style={{paddingBottom: "0px"}}>
                                            ...
                                            <div className="text">
                                                ...
                                                <div style={{ fontSize: "1.25rem", color: "rgb(94, 5, 5)" }}>Visit us today at :</div>
                                                <div>
                                                ...
                                                <div style={{ fontSize: "1.25rem", color: "rgb(94, 5, 5)", paddingTop: "0.75rem" }}>
                                            ...
                                            <div className='upadte-delete' style = {{display:"flex", marginBottom: "0px", paddingBottom: "0px", paddingTop:"12rem"}}>
                                                <span style={{ marginRight: "80%", margin: '0px', paddingBottom:"0px", marginTop:"3.35em" }} className="Delete">
                                                    <OpenModalButton
                                                ...
                                                <span className="Edit">
                                                    <button style={{
                                                        ...
                                                        position: "relative", marginRight: "40%", marginTop: "4em"  
                                                    }}
